    ...
    @foreach($subtema as $subtema)
        <div class="container-item" style="background-image: url('{{$subtema->imagen}}'">
            ...
            <div class="mimi-modal">
                <a id="btn-aprender" href="/ActividadesAprender/{{$subtema->nombre}}/{{$subtema->idteoria}}" class="container-aprender btn-aprender" >
                    <img class="icon-aprender" src="/images/icon_aprender.svg" alt="Aprender">
                    <p>Aprender</p>
                </a>
                <a id="btn-practicar" href="/actividad{{$subtema->id}}" class="container-practicar btn-practicar">
